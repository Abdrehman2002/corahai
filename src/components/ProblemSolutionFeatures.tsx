        ...
        <div className="bento-grid opacity-0 animate-fade-in animation-delay-100">
            <BentoItem className="col-span-2 row-span-2 flex flex-col justify-between">
              <div>
                <div className="w-14 h-14 rounded-2xl bg-foreground flex items-center justify-center mb-4">
                  <PhoneOff className="w-7 h-7 text-background" />
                </div>
              ...
              <div className="mt-6 p-6 bg-secondary/30 rounded-xl">
                <p className="text-sm text-foreground/60 font-medium mb-2">Impact</p>
                <p className="text-3xl font-bold text-foreground">100%</p>
                <p className="text-sm text-foreground/70 mt-1">Call answer rate, day or night</p>
              </div>
            </BentoItem>

            <BentoItem>
              <div className="w-12 h-12 rounded-xl bg-foreground flex items-center justify-center mb-3">
            ...
            <BentoItem className="row-span-2 flex flex-col justify-between">
              ...
              <div className="mt-6 p-4 bg-secondary/30 rounded-xl">
                <p className="text-sm text-foreground/60 font-medium mb-1">Monthly Recovery</p>
                <p className="text-2xl font-bold text-foreground">$2K-$5K</p>
              </div>
            </BentoItem>
            ...
            <BentoItem className="flex flex-col justify-between">
              ...
              <div className="mt-6 p-4 bg-secondary/30 rounded-xl">
                <p className="text-sm text-foreground/60 font-medium mb-1">Weekly Savings</p>
                <p className="text-2xl font-bold text-foreground">10-20 hrs</p>
              </div>
            </BentoItem>
          </div>

        <div className="mt-12 p-6 bg-red-50 dark:bg-red-950/20 border-2 border-red-200 dark:border-red-900 rounded-2xl text-center max-w-4xl mx-auto opacity-0 animate-fade-in animation-delay-300">
